          ...
          <div className="col" id="content">
            <div id="quizContainer">
              ...
              <div className="modal-body">
                <div className="quiz" id="quiz" data-toggle="buttons">
                  ...
                  >
                    Continuar <i className="fa fa-angle-double-right" />
                  </button>
            ...
            <div className="modal-header">
              <h2>{currentQuesObj.quizName}</h2>
                  ...
                  >
                    Niveles <i className="fa fa-undo" />
                  </button>
                </div>
                <div className="modal-body">
                  ...
                  <p>
                    Tiempo:
                    {currentQuesObj.tests[currentTestIndex].time / 60} Minuto(s)
                  </p>
                  <p>Preguntas: {currentQuesObj.tests[currentTestIndex].questions}</p>
                  {score < 60 ? (
                    <h3>Has fallado con un puntaje de {score}%</h3>
                  ) : (
                    <h3>Has pasado con un puntaje de {score}%</h3>
                  )}
                  <hr />
              </div>
            </div>
